...
const en = {
  ...
  "settings.updatesAuto": "Auto",
  "settings.updatesNotify": "Notify",
  "settings.updatesOff": "Never",
  "settings.updatesHint":
    "Auto downloads a new version in the background; Notify only says it's out. Either way it installs when you click its ring.",
  "settings.updatesCheck": "Check now",
  "settings.updatesChecking": "Checking…",
  "settings.updatesUpToDate": "Up to date · checked {ago}",
  "settings.updatesNotChecked": "Not checked yet",
  "settings.updatesFound": "{version} is out",
  "settings.updatesDownloading": "Downloading {version}… {pct}",
  "settings.updatesReady": "{version} is ready",
  ...
  "update.ring.installing": "installing",
  "update.ring.retry": "try again",
  "update.card.available": "Update available",
  "update.card.downloading": "Downloading update",
  "update.card.ready": "Update ready",
  "update.card.installing": "Installing update…",
  "update.card.failed": "Couldn't update",
  "update.card.download": "Download",
  "update.card.restart": "Restart and update",
  "update.card.retry": "Try again",
  "update.card.later": "Later",
  "update.card.restartHint": "CodeNotch closes for a few seconds and opens again, updated.",
  "update.card.passwordHint": "Installing asks for your password.",
  "whatsNew.title": "What's new in {version}",
  "whatsNew.done": "Got it",
  "whatsNew.link": "what's new",
...
const pt: Dict = {
  ...
  "settings.updatesAuto": "Auto",
  "settings.updatesNotify": "Avisar",
  "settings.updatesOff": "Nunca",
  "settings.updatesHint":
    "Auto baixa a versão nova em segundo plano; Avisar só mostra que ela saiu. Nos dois casos, ela só instala quando você clica no anel.",
  "settings.updatesCheck": "Verificar agora",
  "settings.updatesChecking": "Verificando…",
  "settings.updatesUpToDate": "Em dia · verificado {ago}",
  "settings.updatesNotChecked": "Ainda não verificado",
  "settings.updatesFound": "A {version} saiu",
  "settings.updatesDownloading": "Baixando a {version}… {pct}",
  "settings.updatesReady": "A {version} está pronta",
  ...
  "update.ring.installing": "instalando",
  "update.ring.retry": "tentar de novo",
  "update.card.available": "Atualização disponível",
  "update.card.downloading": "Baixando atualização",
  "update.card.ready": "Atualização pronta",
  "update.card.installing": "Instalando atualização…",
  "update.card.failed": "Não deu para atualizar",
  "update.card.download": "Baixar",
  "update.card.restart": "Reiniciar e atualizar",
  "update.card.retry": "Tentar de novo",
  "update.card.later": "Depois",
  "update.card.restartHint": "O CodeNotch fecha por alguns segundos e abre de novo, já atualizado.",
  "update.card.passwordHint": "A instalação pede a sua senha.",
  "whatsNew.title": "O que mudou na {version}",
  "whatsNew.done": "Entendi",
  "whatsNew.link": "novidades",
...
const es: Dict = {
  ...
  "settings.updatesOff": "Nunca",
  "settings.updatesHint":
    "Auto descarga la versión nueva en segundo plano; Avisar solo muestra que salió. En ambos casos, se instala cuando haces clic en su anillo.",
  "settings.updatesCheck": "Buscar ahora",
  "settings.updatesChecking": "Buscando…",
  "settings.updatesUpToDate": "Al día · comprobado {ago}",
  "settings.updatesNotChecked": "Aún sin comprobar",
  "settings.updatesFound": "Salió la {version}",
  "settings.updatesDownloading": "Descargando la {version}… {pct}",
  "settings.updatesReady": "La {version} está lista",
  ...
  "update.ring.restart": "reiniciar",
  "update.ring.installing": "instalando",
  "update.ring.retry": "reintentar",
  "update.card.available": "Actualización disponible",
  "update.card.downloading": "Descargando actualización",
  "update.card.ready": "Actualización lista",
  "update.card.installing": "Instalando actualización…",
  "update.card.failed": "No se pudo actualizar",
  "update.card.download": "Descargar",
  "update.card.restart": "Reiniciar y actualizar",
  "update.card.retry": "Reintentar",
  "update.card.later": "Más tarde",
  "update.card.restartHint": "CodeNotch se cierra unos segundos y vuelve a abrirse, ya actualizado.",
  "update.card.passwordHint": "La instalación pide tu contraseña.",
  "whatsNew.title": "Qué cambió en la {version}",
  "whatsNew.done": "Entendido",
  "whatsNew.link": "novedades",
